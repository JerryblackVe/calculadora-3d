...
const light = {
  ...
  header: {},
  title: { color: '#f1faee' },
  subtitle: { color: 'rgba(241, 250, 238, 0.8)' },
  themeToggle: {},
  statCard: { background: 'rgba(255,255,255,0.1)' },
  statCardHighlight: { background: 'rgba(45, 139, 139, 0.3)' },
  statLabel: { color: 'rgba(241, 250, 238, 0.8)' },
  statValue: { color: '#f1faee' },
  statValueGreen: { color: '#4ade80' },
  dataSection: { background: '#1a2332', borderBottom: '3px solid #2d8b8b' },
  refreshButton: { backgroundColor: '#2d8b8b' },
  dataChip: { background: 'rgba(255,255,255,0.1)' },
  dataText: { color: '#f1faee' },
  lastUpdate: { color: 'rgba(241, 250, 238, 0.6)' },
  configSection: { backgroundColor: 'white' },
  configCard: { background: '#f8fafc', border: '1px solid #e2e8f0' },
  configCardTitle: { color: '#2d8b8b' },
  label: { color: '#64748b' },
  input: { border: '1px solid #e2e8f0', backgroundColor: 'white', color: '#1a2332' },
  tableSection: { backgroundColor: 'white' },
  sectionTitle: { color: '#1a2332' },
  addButton: { backgroundColor: '#2d8b8b' },
  resetButton: { backgroundColor: '#ef4444' },
  headerRow: { backgroundColor: '#1a2332' },
  th: { color: '#f1faee' },
  row: { borderBottom: '1px solid #e2e8f0' },
  td: { color: '#1a2332' },
  inputText: { border: '1px solid #2d8b8b', color: '#1a2332', backgroundColor: 'white' },
  inputNumber: { border: '1px solid #2d8b8b', color: '#1a2332', backgroundColor: 'white' },
  calculated: { backgroundColor: '#e8f5e9' },
  finalPrice: { backgroundColor: '#f0fdf4' },
  footerRow: { backgroundColor: '#f1f5f9' },
  tdFooter: { color: '#1a2332' },
